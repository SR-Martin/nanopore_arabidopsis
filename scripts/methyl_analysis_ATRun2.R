...
meth_tsv <- file.path('../data/methylation/ATRun2/ATRun2_CpG_5mC_counts_all.methylCall')
BS_tsv <- file.path('../data/methylation/BS/BS_CpG_frac.txt')

# TO ADD 2 TO POSITION.
nano=methRead(location = meth_tsv,sample.id="Nanopore ATRun2",assembly="mm9",header=TRUE, context="CpG", resolution="base", mincov = 10,
